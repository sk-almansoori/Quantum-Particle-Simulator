...
all:
	g++ main.cpp -o quantum.exe -L"C:\Users\Saif Khalid Saif\OneDrive - Emirates Schools Establishment\Desktop\quantumraygame\src" -lraylib -lopengl32 -lgdi32 -lwinmm
